...
tf.app.flags.DEFINE_integer('cardinality', 8, '''Cadinality, number of paths in each block''')
tf.app.flags.DEFINE_integer('block_unit_depth', 8, '''the depth of each split. 64 for cifar10
...
tf.app.flags.DEFINE_integer('train_steps', 200, '''Total steps that you want to train''')
...
tf.app.flags.DEFINE_integer('validation_batch_size', 251, '''Validation batch size, better to be
...
time''')
tf.app.flags.DEFINE_integer('decay_step0', 75, '''At which step to decay the learning rate''')
tf.app.flags.DEFINE_integer('decay_step1', 150, '''At which step to decay the learning rate''')
